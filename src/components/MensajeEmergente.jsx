    ...
    <div>
      {
        props.showMessage && (
          <a
            href="#"
            className="cardImg flex flex-col items-center border border-green-200 rounded-lg shadow md:flex-row hover:bg-green-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
